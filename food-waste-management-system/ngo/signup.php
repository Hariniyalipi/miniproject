...
if(isset($_POST['sign']))
{
    ...
    $query="insert into ngo(name,email,password,city,address) values('$username','$email','$pass','$location','$address')";
