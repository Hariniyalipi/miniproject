        ...
        <div class="dash-content">
            ...
            <div class="activity">
                ...
                <div class="get">
                    ...
                    $sql = "SELECT fd.*, ngo.name AS ngo_name 
                            FROM food_donations fd 
                            LEFT JOIN ngo_details ngo ON fd.assigned_to = ngo.id 
                            WHERE fd.assigned_to IS NULL AND fd.location=\"$loc\"";
                    ...
                    // If the admin has taken an order, update the assigned_to field in the database
                                ...
                                <tbody>
                                    <?php foreach ($data as $row) { ?>
                                        <tr>
                                            ...
                                            <td data-label="NGO"><?= $row['ngo_name'] ?></td>
                                            <td data-label="Action" style="margin:auto">
                                                <?php if ($row['assigned_to'] == null) { ?>
                                                    <form method="post" action=" ">
                                                        ...
                                                        <button type="submit" name="food">Assign Order</button>
                                                    </form>
